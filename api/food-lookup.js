...
ingredients: 사진에 보이는 음식의 개별 재료 목록 (배열). 각 재료는 { "name": "재료명", "amount": "수량 단위 · 중량 (예: 2조각 · 30g, 1컵 · 200ml, 1줌 · 40g)", "kcal": 숫자, "carb": 숫자(g), "protein": 숫자(g), "fat": 숫자(g) }
  - name 규칙: 2~4글자의 세련되고 직관적인 표현. 괄호 설명 절대 금지. 슬래시(/) 금지. 요리 용어나 식재료 본래 이름을 활용. 예: "다시/차 국물" → "녹차 육수", "밥(흰쌀)" → "흰밥", "구운 연어(또는 구운 생선 살)" → "구운 연어", "김(잘게 썬 김/김가루)" → "김가루", "간장/소금" → "간장", "아라레/쌀과자 토핑" → "아라레"`;
