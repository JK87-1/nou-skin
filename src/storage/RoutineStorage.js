...
const INGREDIENT_DB = {
  ...
  moisture: [
    ...
    { name: 'Ceramide', nameKo: '세라마이드', icon: '', desc: '피부 장벽의 핵심 구성 성분. 수분 증발 방지 & 외부 자극 차단.', tip: '크림·로션 단계에서 사용. 건조·민감 피부에 필수.', concentration: '0.5~1%', skinTypes: ['건성', '민감성'] },
  ],
  pigmentation: [
  ...
  darkCircles: [
    { name: 'Vitamin K + Caffeine', nameKo: '비타민K + 카페인', icon: '', desc: '눈 밑 혈액 순환 개선 & 부기 감소. 다크서클 완화.', tip: '냉장 보관 후 아이크림으로 사용. 약지로 톡톡 두드려 흡수.', concentration: '카페인 1~3%', skinTypes: ['건성', '복합성', '민감성', '지성'] },
