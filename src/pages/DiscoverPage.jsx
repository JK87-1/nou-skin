              ...
              return (
                <>
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginBottom: 2 }}>
                    <span style={{ fontSize: 18, fontWeight: 600, color: 'var(--text-primary)', letterSpacing: -0.3 }}>{lastVal}{unit}</span>
            ...
            {(() => {
              ...
              return discoveries.map((d, i) => (
                <div key={i} onClick={handleConsult} style={{
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontSize: 12, color: 'var(--text-primary)', lineHeight: 1.5 }}>{d.text}</div>
