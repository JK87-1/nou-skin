        ...
        return (
          ...
          <div ref={gridRef} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 15, margin: '0 18px', position: 'relative' }}>
            {cardOrder.map((cardId, cardIdx) => {
              ...
              if (cardId === 'condition') {
                return editWrap('컨디션', (
                  <div onClick={() => handleCardTap('condition', () => setShowConditionModal(true))} style={{ ..._cs, background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)', cursor: 'pointer', padding: '20px', animation: tappedCard === 'condition' ? 'cardTap 0.3s ease' : 'none', pointerEvents: isEditing ? 'none' : 'auto' }}>
