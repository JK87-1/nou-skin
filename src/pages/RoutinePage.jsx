  ...
  return (
    <div style={{ paddingBottom: 20 }}>
      ...
      <div style={{ padding: '30px 28px 20px', textAlign: 'center' }}>
        <h1 style={{
          fontSize: 24, fontWeight: 500, color: 'var(--text-secondary)',
          fontFamily: "'Pretendard Variable', -apple-system, BlinkMacSystemFont, sans-serif", fontStyle: 'italic',
          marginBottom: 4,
        }}>Daily Ritual</h1>
        <p style={{ fontSize: 13, fontWeight: 500, color: 'var(--text-muted)' }}>오늘의 피부 루틴</p>
      </div>
      ...
      <div style={{ padding: '0 20px' }}>
        ...
        <div style={{ marginBottom: 20 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 500, color: 'var(--ingredient-accent)' }}>
        ...
        <div style={{ marginBottom: 20 }}>
          <div style={{ marginBottom: 12 }}>
            <div style={{ fontSize: 16, fontWeight: 500, color: 'var(--text-secondary)' }}>나에게 맞는 성분</div>
              ...
              <div key={idx} className="card" style={{ padding: '14px 16px', marginBottom: 10 }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1, minWidth: 0 }}>
                    <span style={{ fontSize: 24, fontWeight: 500, flexShrink: 0 }}>{ing.icon}</span>
                    <div style={{ minWidth: 0 }}>
                      <div style={{ fontSize: 16, fontWeight: 500, color: 'var(--ingredient-accent)' }}>{ing.nameKo}</div>
                      <div style={{ fontSize: 11, fontWeight: 500, color: 'var(--text-muted)' }}>{ing.name}</div>
                    </div>
                    {ing.score != null && (
                      <span style={{
                        flexShrink: 0, marginLeft: 'auto', marginRight: 8,
                        fontSize: 10, fontWeight: 500, color: 'var(--ingredient-accent)',
                ...
                <div style={{
                  ...
                  <p style={{ fontSize: 13, fontWeight: 500, color: 'var(--text-secondary)', lineHeight: 1.7, margin: '0 0 10px' }}>{ing.desc}</p>
                  <div style={{
                    display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 8,
                  }}>
                    <span style={{
                      fontSize: 11, fontWeight: 500, color: 'var(--text-muted)', background: 'var(--tag-bg)',
                  ...
                  <div style={{
                    ...
                    <div style={{ fontSize: 11, fontWeight: 500, color: 'var(--ingredient-accent)', marginBottom: 4 }}>사용 팁</div>
                    <p style={{ fontSize: 12, fontWeight: 500, color: 'var(--text-muted)', lineHeight: 1.6, margin: 0 }}>{ing.tip}</p>
                  </div>
                </div>
              </div>
            );
          ...
          <div style={{ display: 'flex', justifyContent: 'space-around' }}>
            {weekly.map((day) => (
              <div key={day.date} style={{ textAlign: 'center' }}>
                ...
                <span style={{
                  fontSize: 10, fontWeight: 500, fontWeight: day.isToday ? 600 : 400,
