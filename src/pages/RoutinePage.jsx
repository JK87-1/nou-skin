              ...
              <div key={idx} className="card" style={{ padding: '14px 16px', marginBottom: 10 }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ minWidth: 0 }}>
                      <div style={{ fontSize: 15, fontWeight: 700, color: '#818cf8' }}>{ing.nameKo}</div>
                    ...
                    {ing.score != null && (
                      <span style={{
                        ...
                        background: 'rgba(167,139,250,0.1)', borderRadius: 20,
                        padding: '3px 8px',
                      }}>{ing.reason}</span>
                    )}
                  </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    padding: '10px 12px', border: '1px solid rgba(167,139,250,0.08)',
                  }}>
                    <div style={{ fontSize: 11, fontWeight: 600, color: '#818cf8', marginBottom: 4 }}>사용 팁</div>
            ...
            {weekly.map((day) => (
              <div key={day.date} style={{ textAlign: 'center' }}>
                <div style={{
                  ...
                  marginBottom: 4,
                  background: day.completed ? '#818cf8'
                    : day.isToday ? 'rgba(167,139,250,0.15)'
                    : day.partial ? 'rgba(167,139,250,0.08)'
                    : 'rgba(255,255,255,0.04)',
                  border: day.isToday && !day.completed ? '2px solid #818cf8' : 'none',
                }}>
                  {day.completed ? (
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                      <path d="M5 12l5 5L20 7" stroke="#fff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <span style={{
                  ...
                  color: day.isToday ? '#818cf8' : '#8888a0',
                }}>{day.dayLabel}</span>
              </div>
            ))}
          </div>
