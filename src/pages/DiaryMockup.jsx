...
function QuickSlider({ icon, label, min, max, step, def, unit, color }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10, padding: "8px 0" }}>
      <span style={{ fontSize: 16, lineHeight: 1.3, fontWeight: 500 }}>{icon}</span>
      <span style={{ fontSize: 12, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-secondary)', width: 30, flexShrink: 0 }}>{label}</span>
      <input type="range" min={min} max={max} step={step} value={val}
        onChange={e => setVal(Number(e.target.value))}
        style={{ flex: 1, accentColor: color }}
      />
      <span style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, color, fontFamily: 'var(--font-display)', width: 36, textAlign: "right" }}>
        {val}{unit}
      </span>
    </div>
  );
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: `${color}18`,
        display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, lineHeight: 1.3, fontWeight: 500,
      }}>{icon}</div>
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
          <span style={{ fontSize: 13, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-primary)' }}>{label}</span>
          <span style={{ fontSize: 16, lineHeight: 1.3, fontWeight: 500, color, fontFamily: 'var(--font-display)' }}>{value}{unit}</span>
        </div>
        ...
        <div style={{ fontSize: 10, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-muted)', marginTop: 4 }}>{description}</div>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="app-container">
      ...
      <div style={{
        ...
        <div style={{ fontSize: 10, lineHeight: 1.3, fontWeight: 500, color: '#888', alignSelf: 'center', marginRight: 4 }}>MOCKUP</div>
        {[
        ...
        <div style={{ minHeight: '100dvh', background: 'var(--bg-secondary)', paddingTop: 44 }}>
          ...
          <div style={{
            ...
            <div style={{ position: 'absolute', inset: 0, overflow: 'hidden' }}>
              <div style={{
                ...
                <div style={{ fontSize: 64, lineHeight: 1.1, fontWeight: 400, opacity: 0.15 }}></div>
              </div>
            ...
            {[
              ...
              <div key={i} style={{
                ...
                <span style={{ fontSize: 13, lineHeight: 1.5, color: 'var(--text-secondary)', fontWeight: 500 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <span style={{ fontSize: 12, lineHeight: 1.5, color: accentColor, fontWeight: 500, letterSpacing: 0.3 }}>분석 완료</span>
                <h2 style={{ fontSize: 24, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-primary)', margin: '4px 0 4px', letterSpacing: -0.3 }}>피부 컨디션</h2>
                <span style={{ fontSize: 12, lineHeight: 1.5, color: 'var(--text-muted)', fontWeight: 500 }}>
              ...
              <div style={{ display: 'flex', gap: 8, animation: 'popIn 0.5s ease-out 0.8s both' }}>
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: 24, fontWeight: 500, color: accentColor, lineHeight: 1.3, fontFamily: 'var(--font-display)', zIndex: 1 }}>78</span>
                  <span style={{ fontSize: 10, lineHeight: 1.3, color: 'var(--text-muted)', fontWeight: 500, marginTop: 1, zIndex: 1 }}>종합</span>
                  <span style={{ fontSize: 10, lineHeight: 1.3, fontWeight: 500, color: '#4ecb71', zIndex: 1 }}>+3</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: 10, marginBottom: 16, animation: 'fadeUp 0.5s ease-out 0.7s both' }}>
              ...
              <button style={{
                ...
                color: 'var(--text-secondary)', fontSize: 14, lineHeight: 1.5, fontWeight: 500, cursor: 'pointer',
              }}> 공유</button>
            </div>
            ...
            <div className="glass-card" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
                <span style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, color: accentColor }}>오늘의 피부 컨디션</span>
                <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 6, padding: '4px 10px', borderRadius: 20, background: `${accentColor}26`, border: `1px solid ${accentColor}4d` }}>
                  <span style={{ fontSize: 16, lineHeight: 1.3, fontWeight: 500, color: accentColor, fontFamily: 'var(--font-display)' }}>A</span>
                  <span style={{ fontSize: 12, lineHeight: 1.5, fontWeight: 500, color: accentColor }}>78점</span>
                </div>
              </div>
              <p style={{ fontSize: 14, fontWeight: 500, color: 'var(--text-secondary)', lineHeight: 1.5, margin: 0 }}>
            ...
            <div className="glass-card" style={{
              ...
              >
                ...
                {!conditionSaved && (
                  <span style={{
                    fontSize: 14, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-dim)',
              ...
              {conditionOpen && !conditionSaved && (
                <div style={{ padding: '0 18px 18px' }}>
                  ...
                  <div style={{ fontSize: 11, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-muted)', marginBottom: 12, letterSpacing: 0.3 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12, padding: '8px 0' }}>
                    <span style={{ fontSize: 16, lineHeight: 1.3, fontWeight: 500 }}></span>
                    <span style={{ fontSize: 13, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-secondary)', flex: 1 }}>어제 음주</span>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16, padding: '8px 0' }}>
                    <span style={{ fontSize: 16, lineHeight: 1.3, fontWeight: 500 }}></span>
                    <span style={{ fontSize: 13, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-secondary)', flex: 1 }}>스트레스</span>
                    <div style={{ display: 'flex', gap: 4 }}>
                      {[1, 2, 3, 4, 5].map(n => (
              ...
              {conditionSaved && (
                <div style={{ padding: '0 18px 16px', display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                  {[" 7h", " 없음", " 2/5"].map((t, i) => (
                    <span key={i} style={{
                      fontSize: 11, lineHeight: 1.3, fontWeight: 500, padding: '4px 10px', borderRadius: 20,
            ...
            <div className="glass-card" style={{ animation: 'fadeUp 0.5s ease-out 0.9s both', boxShadow: 'none' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
                <span style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500 }}></span>
                <span style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, color: accentColor }}>전체 피부 분석</span>
              </div>
              <p style={{ fontSize: 14, fontWeight: 500, color: 'var(--text-secondary)', lineHeight: 1.5, margin: 0 }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: 12, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-primary)', marginBottom: 4 }}>지난 측정 대비 변화</div>
                <div style={{ fontSize: 11, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-muted)', marginBottom: 10 }}>수분·피부톤 개선, 모공은 조금만 신경 쓰면 돼요</div>
            ...
            <div className="glass-card" style={{ padding: '18px 10px', animation: 'fadeUp 0.5s ease-out 1.0s both' }}>
              <div style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, marginBottom: 4, paddingLeft: 8, color: 'var(--text-primary)' }}>
                컨디션 지표 <span style={{ fontSize: 11, lineHeight: 1.3, color: 'var(--text-muted)', fontWeight: 500 }}>일상 관리 포인트</span>
              </div>
              <div style={{ fontSize: 10, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-muted)', paddingLeft: 8, marginBottom: 14 }}>탭하면 과학적 근거</div>
            ...
            <div className="glass-card" style={{ padding: '18px 10px', animation: 'fadeUp 0.5s ease-out 1.1s both' }}>
              <div style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, marginBottom: 14, paddingLeft: 8, color: 'var(--text-primary)' }}>
                노화 지표 <span style={{ fontSize: 11, lineHeight: 1.3, color: 'var(--text-muted)', fontWeight: 500 }}>피부 나이에 큰 영향</span>
              </div>
            ...
            <button style={{
              ...
              backdropFilter: 'var(--card-backdrop)',
              color: '#ADEBB3', fontSize: 16, lineHeight: 1.3, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit',
            ...
            <button style={{
              ...
              background: 'var(--bg-card)', border: 'none',
              backdropFilter: 'var(--card-backdrop)',
              color: 'var(--text-secondary)', fontSize: 16, lineHeight: 1.3, fontWeight: 500, cursor: 'pointer',
              animation: 'fadeUp 0.5s ease-out 1.4s both',
            }}> 다시 측정하기</button>

            <p style={{ textAlign: 'center', fontSize: 11, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-muted)', marginTop: 14, marginBottom: 0 }}>
          ...
          {historyMode !== "insight" && (
            <div style={{ padding: '0 20px' }}>
              <div className="glass-card" style={{ textAlign: 'center', padding: '50px 20px' }}>
                <div style={{ fontSize: 40, lineHeight: 1.1, fontWeight: 400, marginBottom: 12 }}>
                ...
                <div style={{ fontSize: 13, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-dim)', marginTop: 6 }}>
          ...
          {historyMode === "insight" && (
            <div style={{ padding: '0 20px' }}>
              ...
              <div className="glass-card" style={{ animation: 'breatheIn 0.6s ease both' }}>
                <div style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-primary)', marginBottom: 12 }}>데이터 수집 현황</div>
              ...
              <div className="glass-card" style={{ animation: 'breatheIn 0.6s ease 0.1s both' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                  <span style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-primary)' }}>피부 변화 추이</span>
                  <span style={{ fontSize: 10, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-dim)' }}> 음주 · --- 제품 시작</span>
                </div>
              ...
              <div className="glass-card" style={{ animation: 'breatheIn 0.6s ease 0.2s both' }}>
                <div style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-primary)', marginBottom: 4 }}>내 피부에 영향을 주는 것들</div>
                <div style={{ fontSize: 11, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-dim)', marginBottom: 14 }}>60일 데이터 기반 · 상관관계 순위</div>
                ...
                <div style={{ marginTop: 8, padding: '8px 12px', borderRadius: 10, background: 'var(--bg-card)', textAlign: 'center', fontSize: 10, fontWeight: 500, color: 'var(--text-dim)', lineHeight: 1.3 }}>
              ...
              <div className="glass-card" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                  <span style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500 }}></span>
                  <span style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, color: 'var(--accent-primary)' }}>AI 종합 분석</span>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: 12, lineHeight: 1.5, fontWeight: 500, color: 'var(--accent-primary)', marginBottom: 4 }}> 이번 주 추천</div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', padding: '4px 8px' }}>
          {[
            ...
            <div key={i} style={{
              ...
              <span style={{ fontSize: 18, lineHeight: 1.3, fontWeight: 500 }}>{tab.icon}</span>
              <span style={{ fontSize: 10, lineHeight: 1.3, fontWeight: 500, color: tab.active ? 'var(--accent-primary)' : 'var(--tab-inactive)' }}>{tab.label}</span>
            </div>
          ))}
        </div>
      </div>
