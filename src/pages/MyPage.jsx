  ...
  return (
    <div style={{ minHeight: '100dvh', paddingBottom: 40 }}>
      ...
      {(() => {
        ...
        const tabs = [
          { key: 'album', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="3" fill="var(--text-muted)"/><circle cx="8.5" cy="8.5" r="2" fill="var(--card-bg, #fff)"/><path d="M2 16l5-4c1-.8 2-.8 3 0l4 4h8v2a3 3 0 01-3 3H5a3 3 0 01-3-3v-2z" fill="var(--card-bg, #fff)" opacity="0.6"/><path d="M14 14l2.5-2c.8-.6 1.5-.6 2.3 0L22 15v5a3 3 0 01-3 3H8l6-9z" fill="var(--card-bg, #fff)" opacity="0.4"/></svg>, label: '앨범', count: photoCount },
          { key: 'journal', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M6 2h12a2 2 0 012 2v16a2 2 0 01-2 2H6a2 2 0 01-2-2V4a2 2 0 012-2z" fill="var(--text-muted)"/><rect x="7" y="6" width="4" height="12" rx="0.5" fill="var(--card-bg, #fff)" opacity="0.5"/><rect x="13" y="6" width="4" height="12" rx="0.5" fill="var(--card-bg, #fff)" opacity="0.5"/></svg>, label: '저널', count: journalCount },
          { key: 'journey', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><circle cx="7" cy="5" r="3" fill="var(--text-muted)"/><circle cx="17" cy="19" r="3" fill="var(--text-muted)"/><path d="M7 8c0 4 10 4 10 8" stroke="var(--text-muted)" strokeWidth="2.5" strokeLinecap="round"/></svg>, label: '여정', count: `${monthsTogether}개월` },
        ];
        return (
