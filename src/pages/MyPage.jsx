  ...
  return (
    <div style={{ minHeight: '100dvh', paddingBottom: 40 }}>
      ...
      {(() => {
        ...
        const tabs = [
          { key: 'album', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><mask id="album-m"><rect width="24" height="24" fill="white"/><circle cx="8" cy="8" r="2.5" fill="black"/><path d="M1 16l5.5-4.5c1-.8 2-.8 3 0l3.5 3.5 2-1.5c.8-.6 1.7-.6 2.5 0L23 17v7H1z" fill="black"/></mask><rect x="1" y="1" width="22" height="22" rx="3" fill="var(--text-muted)" mask="url(#album-m)"/></svg>, label: '앨범', count: photoCount },
