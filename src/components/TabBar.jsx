  ...
  const tabs = [
    {
      ...
      icon: (active) => {
        ...
        return (
          <svg width="22" height="22" viewBox="-15 -5 256 233" fill="none">
    ...
    },
    {
      ...
      icon: (active) => {
        const c = active ? 'rgba(0,0,0,0.8)' : 'rgba(0,0,0,0.3)';
        return (
          <svg width="22" height="22" viewBox="-5 -2 110 104" fill="none">
    ...
    },
    {
      ...
      label: 'MY',
      icon: (active) => (
        <svg width="22" height="22" viewBox="-10 -10 247 250" fill="none">
