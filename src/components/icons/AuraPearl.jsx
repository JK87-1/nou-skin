...
const DARK_GLOW = { primary: '#F09070', secondary: '#FFD4B8' };
const LIGHT_GLOW = { primary: '#7c3aed', secondary: '#F0A878' };
    ...
    <>
      <defs>
        ...
        <radialGradient id={`${id}-dir-purple`} cx="30%" cy="30%" r="40%">
          <stop offset="0%" stopColor="#F09070" stopOpacity="0.1" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
        ...
        <linearGradient id={`${id}-aurora1`} x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="33%" stopColor="#F0A878" stopOpacity="0.15" />
    ...
    <>
      <defs>
        ...
        <radialGradient id={`${id}-neb-indigo`} cx="75%" cy="68%" r="30%">
          <stop offset="0%" stopColor="#F0A878" stopOpacity="0.12" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
