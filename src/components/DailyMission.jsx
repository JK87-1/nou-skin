      ...
      <div style={{ padding: '0 20px', marginTop: 24 }}>
        ...
        <div style={{ display: 'flex', gap: 6, marginBottom: 18 }}>
          {emptyWeek.map(day => (
            <div key={day.date} style={{
              ...
              <div style={{ fontSize: 11, lineHeight: 1.3, color: day.isToday ? 'var(--day-today-accent)' : 'var(--text-muted)', fontWeight: 500, marginBottom: 2 }}>{day.dayLabel}</div>
              <div style={{ fontSize: 16, lineHeight: 1.3, fontWeight: 500, color: day.isToday ? 'var(--day-today-accent)' : 'var(--text-primary)' }}>{new Date(day.date).getDate()}</div>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', width: 50, height: 50, flexShrink: 0 }}>
            ...
            <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-primary)' }}>0%</div>
          </div>
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 13, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-muted)' }}>오늘의 달성률</div>
            <div style={{ fontSize: 16, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-primary)' }}>0 / 3 완료</div>
          </div>
          <div style={{ fontSize: 11, lineHeight: 1.3, fontWeight: 500, borderRadius: 8, padding: '5px 10px', background: 'var(--bg-card)', color: 'var(--text-muted)', border: 'none' }}>+0 P</div>
        </div>
          ...
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: 6, marginBottom: 6 }}>
                <span style={{ fontSize: 10, lineHeight: 1.3, fontWeight: 500, padding: '2px 8px', borderRadius: 8, background: 'var(--context-bg)', color: 'var(--accent-primary)' }}>메인 미션</span>
                <span style={{ fontSize: 10, lineHeight: 1.3, fontWeight: 500, padding: '2px 8px', borderRadius: 8, background: 'var(--tag-bg)', color: 'var(--accent-streak)' }}>+30 P</span>
              </div>
              <div style={{ fontSize: 16, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-primary)', marginBottom: 4 }}>피부 측정 후 미션이 생성돼요</div>
        ...
        {[{ title: '보너스 미션 1', xp: 15 }, { title: '보너스 미션 2', xp: 10 }].map((b, i) => (
          <div key={i} style={{
            ...
            <div style={{ width: 32, height: 32, borderRadius: 10, background: 'var(--tag-bg)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <span style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, opacity: 0.5 }}></span>
            </div>
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 13, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-primary)' }}>{b.title}</div>
              <div style={{ fontSize: 11, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-muted)' }}>측정 후 공개</div>
            </div>
            <span style={{ fontSize: 10, lineHeight: 1.3, fontWeight: 500, padding: '2px 8px', borderRadius: 8, background: 'var(--tag-bg)', color: 'var(--text-muted)' }}>+{b.xp} P</span>
          </div>
        ))}
      </div>
    );
    ...
    <div style={{ padding: '0 20px', marginTop: 24 }}>
        ...
        {weeklyStatus.map(day => (
          <div key={day.date} style={{
            ...
            {day.completed && !day.isToday && (
              <div style={{ fontSize: 10, lineHeight: 1.3, fontWeight: 500, color: 'var(--accent-success)', marginTop: 2 }}>&#10003;</div>
            )}
            {day.isToday && (
              <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', width: 50, height: 50, flexShrink: 0 }}>
          ...
          <div style={{
            ...
            fontSize: 13, lineHeight: 1.5, fontWeight: 500, fontFamily: 'var(--font-display)',
        ...
        <div style={{
          fontSize: 11, lineHeight: 1.3, fontWeight: 500, borderRadius: 8, padding: '5px 10px',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', position: 'relative' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: 'flex', gap: 6, marginBottom: 6 }}>
                <span style={{
                  fontSize: 10, lineHeight: 1.3, fontWeight: 500, padding: '2px 8px', borderRadius: 8,
              ...
              {/* Title */}
              <div style={{
                fontSize: 16, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-primary)', marginBottom: 4,
          ...
          {missions.main.trackable && !progress.mainCompleted && (
            <div style={{ marginTop: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                {/* Count label */}
                <span style={{ fontSize: 13, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>
          ...
          {progress.mainCompleted && (
            <div style={{
              ...
              fontSize: 13, lineHeight: 1.5, fontWeight: 500, color: 'var(--accent-success)',
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, position: 'relative', zIndex: 1 }}>
                ...
                <button onClick={(e) => { e.stopPropagation(); handleUndoMain(); }} style={{
                  ...
                  borderRadius: 8, padding: '3px 10px', fontSize: 11, lineHeight: 1.3, fontWeight: 500,
          ...
          {missions.sourceScore !== null && (
            <div style={{ fontSize: 10, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-dim)', marginTop: 8, textAlign: 'right' }}>
      ...
      <div style={{ marginBottom: 20, ...fadeUp(0.3) }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
          <span style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-secondary)' }}>보너스 미션</span>
          <span style={{ fontSize: 12, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-muted)' }}>
            ...
            return (
              <div key={b.id ?? i}>
                <div onClick={() => !completed && handleBonusComplete(i)} style={{
                  ...
                  {/* Title */}
                  <span style={{
                    flex: 1, fontSize: 14, lineHeight: 1.5, fontWeight: 500,
                  ...
                  {completed ? (
                    <span style={{
                      fontSize: 10, lineHeight: 1.3, fontWeight: 500, padding: '2px 6px', borderRadius: 8,
                      background: 'var(--tag-bg)', color: 'var(--tag-color)',
                    }}>+{b.xp} P</span>
                  ) : (
                    <span style={{ color: 'var(--text-dim)', fontSize: 14, lineHeight: 1.5, fontWeight: 500 }}>{'\u203A'}</span>
                  )}
                </div>
      ...
      <div style={{ marginBottom: 20, ...fadeUp(0.4) }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
          <span style={{ fontSize: 14, lineHeight: 1.5, fontWeight: 500, color: 'var(--text-secondary)' }}>획득한 뱃지</span>
          <span style={{ fontSize: 11, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-muted)' }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          {badges.map(badge => (
            ...
            >
              <div style={{
                fontSize: 24, lineHeight: 1.3, fontWeight: 500, marginBottom: 4,
              ...
              {badgeTooltip === badge.id && (
                <div style={{
                  ...
                  fontSize: 10, lineHeight: 1.3, fontWeight: 500, color: 'var(--text-secondary)', whiteSpace: 'nowrap', marginBottom: 6,
                  border: 'none',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{
              fontSize: 12, lineHeight: 1.5, fontWeight: 500, marginBottom: 4,
              color: '#2EAA7B',
            }}>AI 피부 코치</div>
            <div style={{ fontSize: 14, fontWeight: 500, color: 'var(--text-secondary)', lineHeight: 1.5 }}>{coachComment}</div>
          </div>
        </div>
      </div>
      ...
      {undoToast && (
        <div style={{
          ...
          <span style={{ fontSize: 18, lineHeight: 1.3, fontWeight: 500 }}><CheckIcon size={20} /></span>
          <span style={{ fontSize: 13, lineHeight: 1.5, color: 'var(--text-primary)', fontWeight: 500 }}>{undoToast.label}</span>
          <button onClick={() => {
            ...
            color: 'var(--accent-primary)',
            borderRadius: 10, padding: '6px 14px', fontSize: 12, lineHeight: 1.5, fontWeight: 500,
      ...
      {xpFloat && (
        <div style={{
          ...
          fontSize: 18, lineHeight: 1.3, fontWeight: 500, color: '#F0B870', fontFamily: 'var(--font-display)',
