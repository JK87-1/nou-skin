  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          fontSize: 14, color: '#374E66', lineHeight: 1.6,
        ...
        {typeof avgScore === 'number' && (
          <div style={{
            ...
            <span style={{ fontSize: 24, fontWeight: 600, color: '#1A1A1A', letterSpacing: -0.5 }}>{Math.round(avgScore)}</span>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={i} style={{
              fontSize: 13, color: '#374E66', lineHeight: 1.7,
              wordBreak: 'keep-all',
