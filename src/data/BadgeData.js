...
const THEMES = [
  // ── 기본 (Lv 1~8) ─────────────────────────────────────────
  { id: 'warmSand',  name: 'Moonlight Silver',  kr: '웜 샌드',    range: [1, 3],   accent: '#FFB347', sub: '#FFD88A', pearl: ['#FFF3A0', '#FFB347', '#F08050'], cloverTheme: 'warmSand',  desc: '은빛 달빛의 고요함' },
  { id: 'obsidianGray',     name: 'Obsidian Gray',     kr: '오브시디언 그레이', range: [4, 5],   accent: '#FFB347', sub: '#A0A0BC', pearl: ['#D4D4E4', '#808080', '#383838'], cloverTheme: 'obsidianGray',     desc: '흑요석의 깊은 광택' },
  ...
  { id: 'onyxBlack',         name: 'Onyx Black',        kr: '오닉스 블랙',      range: [41, 43], accent: '#FFB347', sub: '#FFB347', pearl: ['#C8C8DC', '#5A5A5A', '#141414'], cloverTheme: 'onyxBlack',        desc: '칠흑 속 보랏빛 광채' },
  // ── 전설 (Lv 44~50) ──────────────────────────────────────
