...
const BADGE_DATABASE = {
  score: {
    ...
    badges: [
      ...
      { id: 'score_50', icon: '', name: '작은 불꽃', desc: '피부 종합점수 50점 이상 달성 · 어둠 속에 첫 빛이 켜졌어요', condition: { type: 'score', value: 50 } },
      { id: 'score_60', icon: '', name: '새벽빛', desc: '피부 종합점수 60점 이상 달성 · 수평선 너머로 빛이 번져가요', condition: { type: 'score', value: 60 } },
      { id: 'score_70', icon: '', name: '맑은 햇살', desc: '피부 종합점수 70점 이상 달성 · 구름 위로 따스한 빛이 내려와요', condition: { type: 'score', value: 70 } },
  ...
  mission: {
    label: '작은 모험', subtitle: '데일리 미션 완료', icon: '', color: '#F4B8D4',
    badges: [
      { id: 'mission_10', icon: '', name: '첫 번째 지도', desc: '데일리 미션 누적 10회 완료 · 모험의 지도를 펼쳤어요', condition: { type: 'missionCount', value: 10 } },
      { id: 'mission_30', icon: '', name: '나침반', desc: '데일리 미션 누적 30회 완료 · 방향을 찾아가고 있어요', condition: { type: 'missionCount', value: 30 } },
      { id: 'mission_50', icon: '', name: '비밀의 열쇠', desc: '데일리 미션 누적 50회 완료 · 숨겨진 문이 열려요', condition: { type: 'missionCount', value: 50 } },
      { id: 'mission_100', icon: '', name: '모험의 왕관', desc: '데일리 미션 누적 100회 완료 · 백 번의 모험을 완수했어요', condition: { type: 'missionCount', value: 100 } },
      { id: 'mission_200', icon: '', name: '전설의 모험가', desc: '데일리 미션 누적 200회 완료 · 이 길의 끝을 아는 사람', condition: { type: 'missionCount', value: 200 } },
  ...
  special: {
    ...
    badges: [
      ...
      { id: 'measure_10', icon: '', name: '보물 지도', desc: '피부 측정 누적 10회 달성 · 보물이 묻힌 곳이 보여요', condition: { type: 'measureCount', value: 10 } },
      ...
      { id: 'share_first', icon: '', name: '날개의 편지', desc: '분석 결과 첫 공유 · 소식을 전하는 보물', condition: { type: 'shareCount', value: 1 } },
