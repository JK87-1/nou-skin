...
export const SCIENCE = {
  ...
  moisture: {
    ...
    ranges: [
      ...
      { range: '40% 미만', label: '나쁨', color: '#272727', description: '집중 보습 케어 필요.' },
    ],
  ...
  pores: {
    ...
    ranges: [
      ...
      { range: '40~59점', label: '넓음', color: '#777167', description: '모공 축소 관리 추천.' },
  ...
  redness: {
    ...
    steps: [],
    ranges: [
      { range: '75점 이상', label: '깨끗', color: '#0e6bec', description: '붉은기가 거의 없어요.' },
      { range: '55~74점', label: '양호', color: '#00a0fc', description: '경미한 붉은기. 크게 걱정 없어요.' },
      { range: '35~54점', label: '홍조', color: '#777167', description: '홍조가 눈에 띄어요. 진정 케어 추천.' },
      { range: '35점 미만', label: '나쁨', color: '#272727', description: '지속적 홍조. 피부과 상담 권장.' },
    ],
